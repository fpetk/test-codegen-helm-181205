...
3) Access the `workbench` named `test-codegen-helm-181205-notebook`
...
5) In the terminal, run `cd test-codegen-helm-181205` to navigate to your sample app's directory
